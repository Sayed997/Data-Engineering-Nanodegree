...
#staging tables will not need a sort key as they won't be qeuried
...
#Data table were sorted keeping the order by query in mind
#I did attempt to set data type value constraints on the VarChar types but I kept on recieving errors when running my code
...
staging_events_table_create= ("""
    ...
    distkey(artist);
""")
#Removed key constraints thank you for overall feedback, much appreciated
